...
const ComponentTypeMap = { // ByteSize : TypeArray : JS Type name, Gltf Type name
...
const ComponentVarMap = {  // Component Length of Each Var Type
    SCALAR  : 1,
    VEC2    : 2,
    VEC3    : 3,
    VEC4    : 4,
...
class Gltf{
    ...
    getMesh( id=null ){
        ...
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        let nodes = this.getMeshNodes( mIdx );
    ...
    getSkin( id ){
        ...
        switch( typeof id ){
            case "string" : [ js, idx ] = this.getSkinByName( id ); break;
        ...
        if( bind.elementCnt != js.joints.length ){
