//#region TYPES
type TTypeArray     = Int8Array | Uint8Array | Int16Array | Uint16Array | Uint32Array | Float32Array;
type TTypeArrayCon  = Int8ArrayConstructor | Uint8ArrayConstructor | Int16ArrayConstructor | 
...
const ComponentTypeMap : Record<number, [number, TTypeArrayCon, string, string ]>= { 
...
const ComponentVarMap : Record<string, number> = {  // Component Length of Each Var Type
    SCALAR  : 1,
    VEC2    : 2,
    VEC3    : 3,
    VEC4    : 4,
...
class Mesh{
    ...
    position   : TVec3 | null = null; // Node's Position
    rotation   : TVec4 | null = null; // Node's Rotation
    scale      : TVec3 | null = null; // Node's Scale
}
...
class SkinJoint{
    ...
    bindMatrix  : TMat4 | null  = null; // Inverted WorldSpace Transform
    position    : TVec3 | null  = null; // Local Space Position
    rotation    : TVec4 | null  = null; // Local Space Rotation
    scale       : TVec3 | null  = null; // Local Space Scale
}
//#endregion
