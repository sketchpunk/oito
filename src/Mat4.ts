class Mat4 extends Float32Array{
    ...
    */
    ...
    translate( x: number | TVec3, y ?: number, z ?: number ) : Mat4{
        if( x instanceof Float32Array || ( x instanceof Array && x.length == 3 )){
            y = x[1];
            z = x[2];
            x = x[0];
        }

        if( y == undefined || z == undefined ) return this;
