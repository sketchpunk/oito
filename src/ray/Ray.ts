...
class Ray{
    ...
    */  
    ...
    nearPoint( p: TVec3, distLimit=0.1 ) : number | null{
        ...
        const   dist    = Vec3.sub( p, this.origin ).mul( this.vecLen ),
                t       = ( dist[0] + dist[1] + dist[2] ) / this.vecLen.lenSqr();
...
function pointInTriangle(p, a, b, c) {
    ...
    */
    ...
    inQuad( centerPos: TVec3, w: number, h:number ) : number | null{
        ...
        const   v0 = Vec3.add( centerPos, [-w,  h, 0] ),
                v1 = Vec3.add( centerPos, [-w, -h, 0] ),
                v2 = Vec3.add( centerPos, [ w, -h, 0] );
