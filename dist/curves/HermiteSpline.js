...
class HermiteSpline {
    ...
    get curveCount() { return this._curve_cnt; }
    get pointCount() { return this._point_cnt; }
    //#endregion ////////////////////////////////////////////////////////
    ...
    at(t, pos, dxdy) {
        ...
        if (pos)
            this._at(a, b, c, d, this.time, pos);
        if (dxdy)
            this._dxdy(a, b, c, d, this.time, dxdy);
        return pos || dxdy;
    }
    /** Get position / first derivative of specific curve on the spline  */
    atCurve(idx, t, pos, dxdy) {
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        if (t < 0)
            t = 0;
        else if (t > 1)
