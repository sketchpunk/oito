import type { TVec3, TVec4, TVec4Struct } from '@oito/types';
...
class Quat extends Float32Array{
    ...
    fromNLerp( a: TVec4, b: TVec4, t: number, out ?: Quat ) : this{
        const ti = 1 - t;
        out		 = out || new Quat();
        this[0]	 = a[0] * ti + b[0] * t;
        this[1]	 = a[1] * ti + b[1] * t;
    ...
    static invert( a: TVec4 ) : Quat{
        ...
        if( dot == 0 ){ rtn[0] = rtn[1] = rtn[2] = rtn[3] = 0; return rtn; }
    ...
    static nblend( a: TVec4, b: TVec4, t: number, out ?: Quat ) : Quat{ return new Quat().fromNBlend( a, b, t ); }
