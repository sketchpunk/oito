...
class VoxelGeodesic{
    //#region MAIN
    cells       : Map<string,GeodesicCell> = new Map();
    smooth      = 0.7;
    ...
    addCell( coord: TVec3, midPoint: TVec3 ){
...
//#region SUB TYPES
class GeodesicCell{
    items       : Map<number,GeodesicItem> = new Map();
    midPoint    = [0,0,0];
...
class GeodesicItem{
    ...
    constructor( idx: number ){ this.boneIdx = idx; }
}
//#endregion
